    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        switch (dataSet.get(position).getShowType()) {
            case 1:
                ...
                Glide.with(context).load("http://127.0.0.1:8080/elearn/courses/"+dataSet.get(position).getId()+"/photo")
                ...
                System.out.println("http://127.0.0.1:8080/elearn/courses/"+dataSet.get(position).getId()+"/photo");
                break;
            case 2:
                ...
                System.out.println("http://127.0.0.1:8080/elearn/courses/"+dataSet.get(position).getId()+"/photo");
                Picasso.with(context).load("http://127.0.0.1.138:8080/elearn/courses/"+dataSet.get(position).getId()+"/photo")
            ...
            case 3:
                ...
                System.out.println("http://127.0.0.1:8080/elearn/courses/"+dataSet.get(position).getId()+"/photo");
                Picasso.with(context).load("http://127.0.0.1:8080/elearn/courses/"+dataSet.get(position).getId()+"/photo")
                        .into((ImageView) ((MyViewHolder) holder).itemView.findViewById(R.id.background));
                break;
        }
